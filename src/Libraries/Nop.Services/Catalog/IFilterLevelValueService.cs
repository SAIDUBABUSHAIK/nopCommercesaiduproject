...
/// </summary>
public interface IFilterLevelValueService
{
    /// <summary>
    /// Check if filter levels are disabled
    /// </summary>
    Task<(bool filterLevel1, bool filterLevel2, bool filterLevel3)> IsFilterLevelDisabledAsync();
    ...
    FilterLevelValueProductMapping FindFilterLevelValueProduct(IList<FilterLevelValueProductMapping> source, int productId, int filterLevelValueId);
