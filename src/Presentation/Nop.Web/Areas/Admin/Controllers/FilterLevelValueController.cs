...
public partial class FilterLevelValueController : BaseAdminController
{
    ...
    {
        //prepare model
        var model = await _filterLevelValueModelFactory.PrepareFilterLevelValueModelAsync(new FilterLevelValueModel(), null);
    ...
    public virtual async Task<IActionResult> Create(FilterLevelValueModel model, bool continueEditing)
    {
        ...
        //prepare model
        model = await _filterLevelValueModelFactory.PrepareFilterLevelValueModelAsync(model, null);
    ...
    public virtual async Task<IActionResult> Edit(int id)
    {
        ...
        //prepare model
        var model = await _filterLevelValueModelFactory.PrepareFilterLevelValueModelAsync(null, filterLevelValue);
    ...
    public virtual async Task<IActionResult> Edit(FilterLevelValueModel model, bool continueEditing)
    {
        ...
        //prepare model
        model = await _filterLevelValueModelFactory.PrepareFilterLevelValueModelAsync(model, filterLevelValue);
    ...
    public virtual async Task<IActionResult> ProductAddPopup(AddProductToFilterLevelValueModel model)
    {
        ...
        if (selectedProducts.Any())
        {
            ...
            foreach (var product in selectedProducts)
            {
                ...
                if (_filterLevelValueService.FindFilterLevelValueProduct(existingProductFilterLevelValues, product.Id, model.FilterLevelValueId) != null)
                    continue;
